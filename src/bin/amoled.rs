...
use esp_hal::entry;
use esp_hal::gpio::{Io, Level, NoPin, Output};
use esp_hal::prelude::*;
...
fn main() -> ! {
    ...
    let _led = Output::new_typed(io.pins.gpio38, Level::High);
    ...
    let mut rst = Output::new(io.pins.gpio17, Level::High);
    let cs = Output::new(io.pins.gpio6, Level::High);
